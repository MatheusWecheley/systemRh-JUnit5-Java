...
public class FolhaPagamento {
	...
	public static BigDecimal calcularValorAcrescimoPorDependentes(Funcionario funcionario) {
		BigDecimal totalPagar = new BigDecimal("0");
	...
	public static BigDecimal calcularValorAcrescimoPorTempo(Funcionario funcionario) {
		BigDecimal totalPagar = new BigDecimal("0");
